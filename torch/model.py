...
def get_model(return_sequences=True, stateful=False, dtype=DTYPE, dt=1.0, mlp=True, mlp_trainable=True, share_q_r=True, q_max_base=None, R_0_base=None, D_trainable=False):
    model = BatteryRNN(mlp_trainable=mlp_trainable,dt=dt,q_max_base=q_max_base,R_0_base=R_0_base,D_trainable=D_trainable)
    return model
