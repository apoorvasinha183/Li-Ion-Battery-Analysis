...
class BatteryDataFile():
    ...
    def getDischarge(self, varnames, min_size=0, discharge_type=None):
        ...
        ret = np.array([np.asfarray(x[0,:],dtype="object") for x in self.data[np.where(self.operation_type=='D')[0]][varnames[0]][index]],dtype='object')
...
if __name__ == "__main__":
    ...
    plt.savefig("../Results/Illustration/I-VCharacteristics.png")
    plt.show()
